...
function envTemplate(tenantId: string): string {
  ...
  return [
    ...
    "#",
    "# Sections, in order:",
    "#   1. Auth — sign-up, login and sessions",
    "#   2. Auth — email verification",
    "#   3. Auth — password reset",
    "#   4. Auth — roles and permissions",
    "#   5. Auth — Google and GitHub login",
    "#   6. Email through Resend",
    "#   7. SMS through Twilio",
    "#   8. QA: simulate slow, failing and empty responses",
    ...
    "# Writes to them still need a token. Ignored while roles are on (section 4).",
    ...
    "",
    envSection("2. Auth — email verification (on whenever AUTH_ENABLED=true)"),
    ...
    "# Where the code goes:",
    "#   - with RESEND_API_KEY (section 6): emailed to the address that signed up;",
    ...
    "",
    envSection("3. Auth — password reset (on whenever AUTH_ENABLED=true)"),
    ...
    "# the code is emailed with RESEND_API_KEY, and shown in the Logs tab without.",
    "# Optional: a page of yours the email links to, with #email=…&code=… attached.",
    "# AUTH_RESET_URL=https://your-app.com/reset-password",
    "",
    envSection("4. Auth — roles and permissions (needs AUTH_ENABLED=true)"),
    ...
    "# RBAC_ENABLED=true",
    "",
    envSection("5. Auth — Google and GitHub login (needs AUTH_ENABLED=true)"),
    ...
    "# Left out, the token comes back as JSON instead. Shared by both providers.",
    "# AUTH_OAUTH_REDIRECT=https://your-app.com/login",
    "",
    envSection("6. Email through Resend"),
